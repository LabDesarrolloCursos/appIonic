package es.lab.app.web.rest;

import es.lab.app.AppApp;
import es.lab.app.config.Constants;
import es.lab.app.domain.Authority;
import es.lab.app.domain.User;
import es.lab.app.repository.AuthorityRepository;
import es.lab.app.repository.UserRepository;
import es.lab.app.security.AuthoritiesConstants;
import es.lab.app.service.UserService;
import es.lab.app.service.dto.PasswordChangeDTO;
import es.lab.app.service.dto.UserDTO;
import es.lab.app.web.rest.vm.KeyAndPasswordVM;
import es.lab.app.web.rest.vm.ManagedUserVM;
...
import static es.lab.app.web.rest.AccountResourceIT.TEST_USER_LOGIN;
